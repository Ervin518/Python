...
if 'FGFR4' in lista_gene1:
    print('Gen FGFR4 znajduje sie na indeksie:', lista_gene1.index('FGFR4'))
else:
    print('Brak genu FGFR4')

if 'FGERA4' in lista_gene1:
    print('Gen FGERA4 znajduje sie na indeksie:', lista_gene1.index('FGERA4'))
else:
    print('Brak genu FGERA4')
